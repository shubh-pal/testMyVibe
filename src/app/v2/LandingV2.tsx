    ...
    <div className={styles.page}>
      ...
      <main className={styles.hero}>
        <section className={styles.heroCopy}>
          ...
          <a
            href="https://www.producthunt.com/products/testmyvibe?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-testmyvibe"
            target="_blank"
            rel="noopener noreferrer"
            className={styles.productHuntBadge}
          >
            <img
              alt="TestMyVibe - Audit your product flows with MCP and catch issues early | Product Hunt"
              width={250}
              height={54}
              src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1253053&theme=light&t=1789626911005"
            />
          </a>
        </section>
