...
export default function OrgDashboard() {
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        const res = await checkedFetch("/api/stats");
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-500 text-sm mt-1">
            Everything across all your connected projects.
          </p>
        </div>
      ...
      {stats.projectCount === 0 && (
        <div className="card flex flex-col gap-4 border-indigo-500/30">
      ...
      <div>
        ...
        {stats.recentIssues.length === 0 && (
          <p className="text-neutral-500 text-sm">No issues reported yet.</p>
        )}
